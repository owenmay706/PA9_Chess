// This file contains test cases that verify core functionality
// of the chess game, including piece movement logic for multiple
// piece types. These tests ensure that valid moves are generated
// correctly based on each piece's movement rules.
...
//    int count = pawn.getMoves(movesR, movesC);
//
...
//
//    int movesR[30], movesC[30];
//    int count = rook.getMoves(movesR, movesC);
//
...
//
//    int movesR[30], movesC[30];
//    int count = knight.getMoves(movesR, movesC);
//
...
//
//    int movesR[30], movesC[30];
//    int count = king.getMoves(movesR, movesC);
//
